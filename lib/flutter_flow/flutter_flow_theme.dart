...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color mountbattenPink = const Color(0xFF987284);
  late Color cambridgeBlue = const Color(0xFF9DBF9E);
  late Color beige = const Color(0xFFD0D6B5);
  late Color melon = const Color(0xFFF9B5AC);
}
