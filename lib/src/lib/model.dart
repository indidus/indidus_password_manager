    ...
    return Models(
      ...
      cards: json['cards'] != null
          ? List<FinancialCard>.from(
              (json['cards']).map((e) => FinancialCard.fromJson(e)).toList())
          : [],
      notes: json['notes'] != null
          ? List<Note>.from(
              (json['notes']).map((e) => Note.fromJson(e)).toList())
          : [],
      logins: json['logins'] != null
          ? List<Login>.from(
              (json['logins']).map((e) => Login.fromJson(e)).toList())
          : [],
      ids: json['ids'] != null
          ? List<IdentityCard>.from(
              (json['ids']).map((e) => IdentityCard.fromJson(e)).toList())
          : [],
    );
  }
