                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (_model.isPasswordMismatched == true)
                              Row(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  Padding(
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CREATE_ACCOUNT_SIGN_UP_BTN_ON_TAP');
                                  Function() navigate = () {};
                                  ...
                                  if (_model.passwordController.text ==
                                    ...
                                    setState(() {
                                      _model.isPasswordMismatched = false;
                                    });
                                    ...
                                    navigate = () => context.goNamedAuth(
                                        'LoginsPage', context.mounted);
                                  } else {
                                    logFirebaseEvent(
                                        'Button_update_page_state');
                                    setState(() {
                                      _model.isPasswordMismatched = true;
                                    });
                                  }
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'CREATE_ACCOUNT_RichText_0qskdwvy_ON_TAP');
